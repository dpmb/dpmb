...
Bisher haben wir hier nur besprochen, wie Sie bereits installierte 
...
die genannte Version installiert, sofern diese verfügbar ist. Die 
Versionsangabe sagt selten etwas darüber aus, ab wann die Version 
verfügbar war.
