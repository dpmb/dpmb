// Datei: ./praxis/mit-aptitude-vormerkungen-machen/mit-aptitude-vormerkungen-machen.adoc
...
Beachten Sie bitte, dass diese Vormerkungen in keinerlei Zusammenhang zu
den Vormerkungen durch `aptitude` stehen.
====

// Vormerkungen über die Kommandozeile durchführen
include::vormerkungen-ueber-die-kommandozeile-durchfuehren.adoc[]

// Vormerkungen über die Textoberfläche durchführen
include::vormerkungen-ueber-die-textoberflaeche-durchfuehren.adoc[]

// bestehende Vormerkungen anzeigen
include::bestehende-vormerkungen-anzeigen.adoc[]

// Vormerkungen simulieren
include::vormerkungen-simulieren.adoc[]

// Vormerkungen wieder aufheben
include::vormerkungen-wieder-aufheben.adoc[]

// Vormerkungen ausführen
include::vormerkungen-ausfuehren.adoc[]

// Risiken und Seiteneffekte
include::risiken-und-seiteneffekte.adoc[]

// Datei (Ende): ./praxis/mit-aptitude-vormerkungen-machen/mit-aptitude-vormerkungen-machen.adoc
