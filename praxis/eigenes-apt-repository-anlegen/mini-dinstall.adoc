...
<<metapakete-bauen>> erzeugte Metapaket 'meta-mc'. Der Schalter `-u` im Aufruf 
kürzt `--unchecked` ab und überspringt den Test der kryptographischen 
Signaturen zum Paket.
