...
von nicht-offiziellen Repositories und Webseiten zu beziehen. Dabei findet
keine Authentizitätsprüfung der Pakete statt, was in der heutigen Zeit als
grob fahrlässig einzustufen ist. Keiner weiß, was Ihnen da als Software
untergejubelt wird. 
...
Von daher raten wir Ihnen von der Benutzung von `deb-get` ab.
