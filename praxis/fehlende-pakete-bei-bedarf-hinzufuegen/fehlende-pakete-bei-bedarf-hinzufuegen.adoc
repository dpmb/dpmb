...
cool, wenn das Debian-System diesen Bedarf erkennen würde und passend
darauf reagieren könnte. Gleiches gilt für Software, deren Fehlen im
laufenden Betrieb bemerkt wird, bspw. indem das entsprechende Paket
vorgeschlagen wird, in welchem sich die Software befindet. Womit 
beide Szenarien umsetzbar sind, lesen Sie nachfolgend.
