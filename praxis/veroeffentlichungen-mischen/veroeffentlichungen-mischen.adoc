// Datei: ./praxis/veroeffentlichungen-mischen/veroeffentlichungen-mischen.adoc
...
die Veröffentlichung eines Pakets aus Debian 'stable' deutlich. Besteht
...
include::pinning-default.adoc[]

// `apt-get` mit expliziter Angabe der Veröffentlichung
include::pinning-apt-get.adoc[]

// Von APT zu APT-Pinning
include::von-apt-zu-apt-pinning.adoc[]

// APT-Pinning paketweise festlegen
include::pinning-paketweise-festlegen.adoc[]

// Praktische Beispiele
include::pinning-praktische-beispiele.adoc[]


// Datei (Ende): ./praxis/veroeffentlichungen-mischen/veroeffentlichungen-mischen.adoc
