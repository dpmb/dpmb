...
deren Ergebnisse leider nicht zueinander kompatibel sind. Das erste Werkzeug
heißt `dpkg-sig` (Debianpaket 'dpkg-sig' <<Debian-Paket-dpkg-sig>>) und das 
zweite `debsigs` (Debianpaket 'debsigs' <<Debian-Paket-debsigs>>).
