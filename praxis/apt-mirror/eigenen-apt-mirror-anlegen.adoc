...
darin, dass bei ersterem nur die bereits nachgefragten Pakete vorgehalten
...
spiegelt den offiziellen Paketbestand und macht ihn für die Benutzer,
...
jedoch dafür zu sorgen, dass der lokale Paketmirror stets aktuelle Pakete
vorhält.
