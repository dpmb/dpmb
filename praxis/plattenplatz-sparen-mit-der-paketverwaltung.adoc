...
* konsequent von Anfang an sein:
** nur die Pakete installieren, die tatsächlich benötigt und auch benutzt werden
** unnötige Pakete identifizieren und entfernen, sofern möglich
** `tasksel` vermeiden

* siehe ReduceDebian -- Reducing the size of the Debian Installation
unter Footprint unter <<ReduceDebian>>
...
* Softwaretests in Virtuelle Maschinen oder Container auslagern
** damit verringert sich der Ballast, der später vielleicht wieder aufgeräumt werden muss
...
(((Bleachbit)))
* bleachbit <<bleachbit>>
* "ith BleachBit you can free cache, delete cookies, clear Internet history, shred temporary files, delete logs, and discard junk you didn't know was there. Designed for Linux and Windows systems, it wipes clean thousands of applications including Firefox, Adobe Flash, Google Chrome, Opera, and more."
