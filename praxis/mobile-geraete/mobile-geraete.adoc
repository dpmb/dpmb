...
eingeschätzt wird. Mit Hilfe der beiden Werkzeuge `xrandr` und 
`arandr` stellen Sie die gewünschte bzw. für Sie passende Auflösung 
und Helligkeit ein. Ersteres ist ein Kommandozeilenwerkzeug, das 
Zweite beglückt Sie hingegen mit einer graphischen 
Bedienoberfläche.
