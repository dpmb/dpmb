...
* weniger Bildschirmgröße resultiert ... 
** in weniger Gewicht
** in einem geringeren Stromverbrauch des Gerätes
** kleinere Darstellung der Bedienoberflächen der Werkzeuge
* xrandr und arandr 
** für Auflösung und Helligkeit
