...
einen das Schlüsselwort `Section`. Von Nutzen sind hier die beiden 
Werkzeuge `apt-cache` und `apt` in Kombination mit `sed`. Unerheblich ist, 
ob das Paket bereits installiert ist, oder nicht.
