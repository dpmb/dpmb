...
image::praxis/aehnliche-pakete-finden/debian-webseite-pakete-datenbanken.png[id="fig.debian-webseite-pakete-datenbanken", width="60%"]
** 
* Suche über die webbasierte Paketübersicht (packages.debian.org)
* Softwareübersicht im Wiki der Ubuntuusers
