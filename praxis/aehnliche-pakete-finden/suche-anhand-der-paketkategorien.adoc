...
Suche über die Paketübersicht auf der Debian-Webseite <<Debian-Paketsuche>> :: 
  Einblendung von ähnlichen Paketen zu einem bereits ausgewählten Paket in der 
  rechten Randleiste, hier für das Paket 'iftop' (siehe grüne Einrahmung in 
  <<fig.debian-webseite-pakete-iftop>>)
