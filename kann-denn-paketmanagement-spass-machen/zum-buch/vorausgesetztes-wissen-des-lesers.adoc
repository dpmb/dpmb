...
meisten Beispiele im Buch auch daher. Spätere Inhalte setzen auf dem
Nachfolger Debian 8 'Jessie' und Debian 9 'Stretch' auf. Alle Ausnahmen
sind entsprechend gekennzeichnet, bspw. wenn wir auf ein Derivat wie
Ubuntu zurückgegriffen haben.
