...
`netselect` <<Debian-Paket-netselect>> und `netselect-apt`
<<Debian-Paket-netselect-apt>> die besseren Mittel der Wahl. Damit
finden Sie den Spiegelserver heraus, der netztechnisch von ihrem
aktuellen Standort aus am besten erreichbar ist.
