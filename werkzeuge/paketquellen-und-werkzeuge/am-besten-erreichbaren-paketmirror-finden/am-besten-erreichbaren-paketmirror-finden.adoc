...
// TODO: apt-spy hier und sonst überall entfernen, in Jessie und Stretch wegen  https://bugs.debian.org/779468 nicht mehr dabei und keine Besserung in Sicht.
...
hat es jedoch weder nach Debian 8 'Jessie' noch nach Debian 9
'Stretch' geschafft, steht jedoch vorerst weiterhin für _unstable_ zur
Verfügung.
