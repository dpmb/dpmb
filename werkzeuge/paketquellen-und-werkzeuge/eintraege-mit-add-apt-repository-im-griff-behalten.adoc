// Datei: ./werkzeuge/paketquellen-und-werkzeuge/eintraege-mit-add-apt-repository-im-griff-behalten.adoc
...
<<Debian-Paket-software-properties-common>>. Beide basieren auf dem
Quellpaket und Projekt Software Properties <<Software-Properties>>.
Es stellt graphische Komponenten bereit, die bspw. auch im Rahmen von 
Synaptic (siehe <<gui-synaptic>>) zum Einsatz kommen. Diese graphischen
