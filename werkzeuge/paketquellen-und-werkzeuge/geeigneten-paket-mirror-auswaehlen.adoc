...
* mittlerweile bestehen eine Reihe von Paketsuchmaschinen
* aggregieren diverse Paketquellen und machen die darüber bereitstehenden Pakete über eine einheitliche Schnittstelle zugänglich

* Auswahl uns bekannter Quellen:
  - https://pkgs.org/ <<pkgs>>
  - https://repology.org/ <<repology>>
  - http://rpmfind.net/ (Fokus auf `rpm`-Pakete) <<rpmfind>>

* Download einzelner Pakete (Bezug über Weboberfläche) ohne Prüfung auf Paketabhängigkeiten
