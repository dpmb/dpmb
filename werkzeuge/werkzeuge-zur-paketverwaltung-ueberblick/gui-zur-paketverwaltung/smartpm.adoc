// Datei: ./werkzeuge/werkzeuge-zur-paketverwaltung-ueberblick/gui-zur-paketverwaltung/smartpm.adoc
...
es auf Python 2 und PyGTK aufbaute, die beide "End of Live" sind,
