...
später veröffentlichten Pakete sind lediglich Non-Maintainer-Uploads
(NMU) und damit ohne kontinuierliche Betreuung. Zudem kommt hinzu, dass
das Projekt <<aptsh-Projekt>> seit dem Auf-und-Ab von berliOS
<<berliOS>> unter wechselnden Adressen auffindbar ist. Das vereinfacht
