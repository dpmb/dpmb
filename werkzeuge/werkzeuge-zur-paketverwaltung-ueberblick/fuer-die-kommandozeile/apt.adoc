...
noch vom Debian QA soweit nötig gepflegt. Es kann daher passieren,
dass es in neueren Debian- und Ubuntu-Veröffentlichungen nicht
enthalten sein, da es nicht mehr weiterentwickelt wird. Siehe auch
<<aptsh>>.
