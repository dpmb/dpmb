...
| Graphical User Interface (GUI) | Synaptic, SmartPM, Ubuntu Software Center, Muon, PackageKit, Apper (früher 'KPackageKit'), `gdebi` | Yet another Setup Tool 2 (YaST2), DrakConf
