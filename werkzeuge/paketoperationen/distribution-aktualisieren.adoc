...
problemlos über die Bühne ging. Beim Wechsel von Debian 7 auf Debian 8
_Jessie_ war vor allem der Wechsel von Apache 2.2 auf Apache 2.4 mit
manuellen Anpassungen ander Apache-Konfiguration verbunden. Beim
Wechsel von Debian 8 nach Debian 9 _Stretch_ muss darauf geachtet
werden, dass lokal installierte PHP-Anwendungen auch mit PHP 7.0
kompatibel sind.
