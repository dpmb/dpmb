...
(((dpkg-deb, --field)))
(((Debianpaket, dpkg)))
(((Paketabhängigkeiten, Auflistung mit dpkg)))
(((Paketabhängigkeiten, Auflistung mit dpkg-deb)))
...
// Stichworte für den Index
(((apt-cache, show)))
(((Paketabhängigkeiten, Auflistung mit apt-cache)))
...
(((apt-rdepends)))
(((Debianpaket, apt-rdepends)))
(((Paketabhängigkeiten, Auflistung mit apt-rdepends)))
...
(((Paketabhängigkeiten, Auflistung mit aptitude)))
...
(((grep-status, -s)))
(((Debianpaket, dctrl-tools)))
(((Paketabhängigkeiten, Auflistung mit grep-aptavail)))
(((Paketabhängigkeiten, Auflistung mit grep-status)))
...
[[paketabhaengigkeiten-anzeigen-rueckwartsabhaengigkeiten]]
...
// Stichworte für den Index
(((apt-cache, rdepends)))
(((Paketabhängigkeiten, Auflistung der Rückwärtsabhängigkeiten mit apt-cache)))
...
(((apt-rdepends, -r)))
(((Debianpaket, apt-rdepends)))
(((Paketabhängigkeiten, Auflistung der Rückwärtsabhängigkeiten mit apt-rdepends)))
...
(((Paketabhängigkeiten, Auflistung der Rückwärtsabhängigkeiten mit aptitude)))
...
// Stichworte für den Index
(((apt-cache, unmet)))
(((Paketabhängigkeiten, Auflistung der unerfüllten Abhängigkeiten)))
