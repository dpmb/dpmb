...
// Stichworte für den Index
(((apt-cache, rdepends)))
(((Paketabhängigkeiten, Rückwärtsabhängigkeiten mit apt-cache auflisten)))
...
(((apt-rdepends, -r)))
(((Debianpaket, apt-rdepends)))
(((Paketabhängigkeiten, Rückwärtsabhängigkeiten mit apt-rdepends auflisten)))
...
(((Paketabhängigkeiten, Rückwärtsabhängigkeiten mit aptitude auflisten)))
