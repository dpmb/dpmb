...
alle Abhängigkeiten eines gegebenen Pakets heraussucht, ``denkt'' `aptitude
search ?depends(…)` andersherum und durchsucht die Abhängigkeiten aller
Paket nach einem Muster, sucht also nach Abhängigkeiten auf ein Paket
bzw. einer Zeichenkette oder einem regulären Ausdruck.
