...
Paketbeschreibung heraus. Im nachfolgenden Aufruf kommen `-F Package`
zum Abgleich des Musters mit dem Paketnamen und `-s Depends` zur Ausgabe
des `Depends`-Feldes zum Einsatz.
