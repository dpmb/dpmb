...
.Suche nach verfügbaren Paketen mittels `apt-cache`
----
$ apt-cache search OpenTTD
catcodec - Werkzeug zum De-/kodieren der Sample-Kataloge für OpenTTD
openttd - Erweiterte Neuumsetzung von »Transport Tycoon Deluxe«
openttd-data - Gemeinsame Datendateien für das Spiel OpenTTD
openttd-opengfx - Freier Grafiksatz für das Spiel OpenTTD
