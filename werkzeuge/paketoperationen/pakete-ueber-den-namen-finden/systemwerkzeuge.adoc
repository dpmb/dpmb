...
Die _ausführlichere Suche_ erreichen Sie mittels kbd:[Ctrl]+kbd:[F] oder
...
und den bereitgestellten Paketen genauer spezifizieren können. Bei
dieser Suche versteht Synaptic auch Fragmente, d.h. es interpretiert den
Suchtext als Teilstring. <<fig.synaptic-suche-nach-namen>> zeigt das
Suchergebnis für das Fragment `fce`.
