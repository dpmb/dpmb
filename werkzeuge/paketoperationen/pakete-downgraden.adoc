...
das Paket `openvpn` aus der stabilen Veröffentlichung. Um exakt das
Paket `openvpn` anzusprechen und diejenigen Pakete auszublenden, die
so ähnlich heißen, wurde der Paketname als regulärer Ausdruck
formuliert.
