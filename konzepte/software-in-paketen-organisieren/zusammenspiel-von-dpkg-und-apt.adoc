...
`-T`'Ausgabeformat' in eine hübsche Grafik um. Aus Ausgabeformat
...
bitte, dass `dot` zwischen dem Schalter und dem von Ihnen gewählten
Ausgabeformat kein Leerzeichen erlaubt.
