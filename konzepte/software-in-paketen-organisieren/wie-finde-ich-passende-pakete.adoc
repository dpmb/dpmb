// Datei: ./konzepte/software-in-paketen-organisieren/wie-finde-ich-passende-pakete.adoc
...
private und unternehmenseigene Repositories und Spiegelserver ('Mirrors'). Für die
