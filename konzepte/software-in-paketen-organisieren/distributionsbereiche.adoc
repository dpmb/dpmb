...
(((Software, frei)))
(((Software, unfrei)))
In Debian sind die Softwarepakete in die folgenden vier Bereiche
unterteilt:
...
Debian im Jahre 2022 von _non-free_ abgetrennt <<gr-non-free-firmware>>. 
In vorherigen Veröffentlichungen waren unfreie Firmware-Pakete im 
Bereich _non-free_ untergebracht.
