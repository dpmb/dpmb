...
markenrechtlichen Einigung im Frühjahr 2016 steht an, dass ab Debian 9
'Stretch' Firefox und Thunderbird wieder zu Debian zurückkehren und
Iceweasel und Icedove aufgegeben werden.
