...
Die Paketklassifikation _experimental_ hat keinen eigenen Alias-Namen.
Das rührt daher, dass es keine eigenständige Veröffentlichung von Debian
GNU/Linux darstellt.
