...
(((Prozessorarchitekturen, veraltete Architekturen)))

==== Nicht mehr unterstützte Architekturen ab Debian 13 ==== 

Das Debian-Projekt kündigte im Herbst 2024 an, mit der 
...
und wurde durch die Architektur 's390x' ersetzt (siehe 
