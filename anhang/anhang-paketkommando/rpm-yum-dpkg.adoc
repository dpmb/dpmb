...
| Guix       | `guix -I` 'Paketname' | alle installierten Pakete mit dem Paketnamen auflisten
|            | `guix -p` 'Profilname' `-I` 'Paketname' | alle installierten Pakete mit dem Paketnamen des benannten Profils auflisten
