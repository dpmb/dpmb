...
Installationsstatus zu einem einzelnen Softwarepaket auf. Für `dpkg`
gehen wir darauf genauer in ``Liste der installierten Pakete anzeigen un
deuten'' unter <<liste-der-installierten-pakete-anzeigen-und-deuten>>
ein.
