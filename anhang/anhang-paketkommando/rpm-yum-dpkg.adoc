...
Verzeichnisse zu einem Paket gehören, bevor dieses installiert wird. 
...
- `rpm` kann das, für `dpkg` und `apt` siehe dazu <<konfigurationsdateien-eines-pakets-anzeigen>>
- `rpm`
