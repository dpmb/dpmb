...
und unter Aktualisierbare Pakete anzeigen'' in
...
Installationsstatus zu einem einzelnen Softwarepaket auf. Für `dpkg` und
`aptitude`gehen wir darauf genauer in ``Liste der installierten Pakete
anzeigen und deuten'' unter
<<liste-der-installierten-pakete-anzeigen-und-deuten>> ein.
